+++
title = "Streaming Audio APIs - Adding Metrics"
date = "2026-07-15"
path = "2026/07/15/streaming-audio-APIs:-adding-metrics"
aliases = ["/2026/07/15/streaming-audio-APIs:-adding-metrics.html"]
+++
In the previous sections we've designed and implemented a websocket service that 
...
making it a little redundant. But one extra metric doesn't hurt and it functions
as a sanity check that the metrics are correct.
...
If you go into Grafana and select Explore/Metrics you can find all the metrics
present in a list of graphs. Consult the Grafana docs and you can see how to
make dashboards or setup alerts on those metrics. I'll just leave you with this
screenshot taken after starting it up and running a file through it:

![image info](/assets/streaming_series/metrics_exploration.png)
