+++
title = "Streaming Audio APIs: the Model"
date = "2024-12-03"
path = "2024/12/03/streaming-audio-APIs:-the-model"
aliases = ["/2024/12/03/streaming-audio-APIs:-the-model.html"]

[extra]
mathjax = true
+++
This entry will lean a lot on types from [streaming API design](/2024/10/20/designing-a-streaming-audio-API/)
